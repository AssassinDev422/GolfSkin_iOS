...
@interface AllDraftersViewController : UIViewController<UITableViewDelegate, UITableViewDataSource, CreateDraftVCDelegate, EditDraftVCDelegate>
...
@property (nonatomic, strong) DraftersViewController *draftersVC;
...
@property (nonatomic, strong) id <DraftersVCDelegate> draftersVCDelegate;
