...
@interface AllDraftersTableViewCell() <UIGestureRecognizerDelegate>
...
@implementation AllDraftersTableViewCell
...
{
    if (sender == self.btnHide) {
        [self.delegate OnHide:self.nIndex];
    } else {
...
- (void)setItemText:(NSString *)itemText
{
    ...
    self.lblEmail.text = _itemText;
}

- (CGFloat)buttonTotalWidth
{
    return CGRectGetWidth(self.btnHide.frame);
}
    ...
    switch (recognizer.state) {
        ...
        case UIGestureRecognizerStateEnded:
            if (self.startingRightLayoutConstraintConstant == 0) { //1
                //We were opening
                CGFloat halfOfButtonOne = CGRectGetWidth(self.btnHide.frame) / 2; //2
                ...
                //We were closing
                CGFloat buttonOnePlusHalfOfButton2 = CGRectGetWidth(self.btnHide.frame) + (CGRectGetWidth(self.btnHide.frame) / 2); //4
